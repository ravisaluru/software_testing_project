...
public class VueCarte extends JPanel {
	 ...
	 *
	 * @param g
	 *            le graphique dans lequel dessiner.
	 */
	@Override
	...
	private void placementGrille() {
		...
		this.xGrille = (this.largeurEcran - (this.tailleCase * this.largeurGrille))
				/ diviseurLargeur;
		this.yGrille = (this.hauteurEcran - (this.tailleCase * this.hauteurGrille))
				/ diviseurHauteur;
